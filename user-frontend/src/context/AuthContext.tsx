...
import { fetchCurrentUser, logoutFromBackend } from '../services/auth'

type AuthContextType = {
  user: BackendUser | null
  isAuthenticated: boolean
  token: string | null
  setAuthenticatedUser: (user: BackendUser | null, token: string | null) => void
  logout: () => Promise<void>
}

export const AuthContext = createContext<AuthContextType | undefined>(undefined)

const AUTH_USER_STORAGE_KEY = 'timetrack_auth_user'
const AUTH_TOKEN_STORAGE_KEY = 'timetrack_access_token'
